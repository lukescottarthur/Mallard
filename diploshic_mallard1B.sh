...
mkdir mallardFV
mv mallardtest1B/*.fvec mallardFV/
mkdir mallardTrainingSets
diploSHIC makeTrainingSets mallardFV/neutral_mallard1.gz.fvec mallardFV/soft mallardFV/hard 5 0,1,2,3,4,6,7,8,9,10 mallardTrainingSets/
