# GFMxWM - pcadapt whole genome analysis - revised for cross analysis comparison. This script calculates pcadapt p-values across sliding windows and outputs them into a csv file.
...
bed <- read.pcadapt("/home/las80898/mallard_wholegenome_data/GFMxWM.bed", type = "bed")
